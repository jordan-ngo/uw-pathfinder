...
public class Path<T> implements Iterable<Path<T>.Segment> {
    ...
    /**
     * @return The point T at the beginning of this path.
     */
    public T getStart() {
        return start;
    }
    ...
    /**
     * @return The point T at the end of this path, which may be the start point T if this path
     ...
     * both paths are empty, they are only equal if their starting point T is equal.
     *
    ...
    /**
     * Segment represents a single segment as part of a longer, more complex path between points T.
    ...
    public class Segment {
         ...
         *
         * @param start The starting point T of this segment.
         * @param end   The ending point T of this segment.
         * @param cost  The cost of travelling this segment.
         * @throws NullPointerException     if either point T is null.
        ...
        /**
         * @return The beginning point T of this segment.
         */
        public T getStart() {
        ...
        /**
         * @return The ending point T of this segment.
         */
        public T getEnd() {
            return this.end;
        }
